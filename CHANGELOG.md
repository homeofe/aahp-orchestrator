...
- Fixed `postcss <8.5.10` XSS vulnerability (GHSA-qx2v-qp2m-jg93) via lockfile update
- Fixed `uuid <14.0.0` buffer bounds vulnerability (GHSA-w5hq-g745-h8pq) via `overrides.uuid >=14.0.0`
